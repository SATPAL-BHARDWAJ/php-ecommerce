...
--
-- Host: localhost
-- Generation Time: Sep 14, 2021 at 01:06 PM
...
(2, 1, 'MICROSOFT Surface Pro 4 & Typecover - 128 GB', '<p>Surface Pro 4 powers through everything you need to do, while being lighter than ever before. The 12.3 PixelSense screen has extremely high contrast and low glare so you can work through the day without straining your eyes</p>', 'microsoft-surface-pro-4-typecover-128-gb', 799, 'microsoft-surface-pro-4-typecover-128-gb.jpg', '2018-05-10', 3),
...
(29, 4, 'Samsung Galaxy S9+ [128 GB]', '<p>Dual Aperture supports F1.5 and F2.4 modes. Installed on the rear camera (Galaxy S9)/rear wide camera (Galaxy S9+).</p>', 'samsung-galaxy-s9-128-gb', 889.99, 'samsung-galaxy-s9-128-gb.jpg', '2018-07-09', 3);
